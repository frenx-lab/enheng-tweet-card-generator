...
当前素材库包含 85 条公开内容快照、恩亨头像、12 张本地摄影背景、推文卡片和 3:4 海报导出。其中 66 条独立推文来自 `0xiang/enheng-skill` 的 111 条精选证据；45 条回复已自动排除，并对现有内容做了去重。证据库字段是公开原文摘录，长文、投资、收益、产品活动和时效性数据在发布前必须回到原推及官方来源复核；页面内容不构成投资建议。
