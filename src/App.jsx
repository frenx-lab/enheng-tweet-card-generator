...
export function App() {
  ...
  return <main className="app-shell">
    <header className="topbar"><div className="brand-mark">EH</div><div><p className="eyebrow">ENHENG CONTENT LAB</p><h1>嗯哼推文卡片生成器</h1></div><div className="privacy-badge"><ShieldCheck weight="fill" /> 20 条公开推文 · 本地生成</div></header>
